...
readonly DEFAULT_INTERNAL_PORT=38021
...
readonly HAPROXY_SERVER_NAME="ddg"
...
start_mcp_server() {
    local mcp_server_cmd="npx -y @oevortex/ddg_search"
    ...
    echo "Launching DuckDuckGo MCP with protocol: ${PROTOCOL_DISPLAY}"
